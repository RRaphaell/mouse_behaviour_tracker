...
from files.frontend import st_label_studio
from files.app_configs_builder import get_app_config
...
from files.style import set_page_container_style
...
from files import streamlit_debug
...
def main():
    ...
    st.markdown(image_text_html(
        'pages/files/images/label_studio_logo.png', 'Label Studio Demo',
    ...
    st.sidebar.image('./pages/files/images/opossum.png', width=140, output_format='png')
